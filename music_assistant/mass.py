...
from music_assistant.controllers.media_files import MediaFilesController
...
class MusicAssistant:
    ...
    async def start(self) -> None:
        ...
        self.media_files = MediaFilesController(self)
        ...
        # register HTTP upload route for media files (after webserver setup)
        self.webserver.register_dynamic_route(
            "/upload", self.media_files.handle_http_upload, "POST"
        )
        # register video streaming route
        self.webserver.register_dynamic_route(
            "/video/stream", self.media_files.handle_video_stream, "GET"
        )
        # register video thumbnail route
        self.webserver.register_dynamic_route(
            "/video/thumbnail", self.media_files.handle_thumbnail, "GET"
        )
        # setup discovery
